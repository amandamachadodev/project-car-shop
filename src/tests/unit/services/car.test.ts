...
import { carMock, carMockForChange, carMockForChangeWithId, carMockInvalid, carMockWithId } from '../../unit/mocks/carMock';
...
describe('Car Service', () => {
	...
	before(() => {
        ...
        sinon.stub(carModel, 'delete').resolves(carMockForChangeWithId);
    ...
    describe('Deleting a Car', () => {
		...
		it('Failure: id not found', async () => {
			sinon.restore();
			sinon.stub(carModel, 'delete').rejects({ message: ErrorTypes.InvalidMongoId });
			try {
